...
const alertVariants = cva("relative w-full rounded border-2 p-4", {
  variants: {
    ...
    status: {
      error: "bg-red-300 text-red-800 border-2 border-black",
      success: "bg-green-300 text-green-800 border-2 border-black",
      warning: "bg-yellow-300 text-yellow-800 border-2 border-black",
      info: "bg-blue-300 text-blue-800 border-2 border-black",
    },
  },
  defaultVariants: {
    variant: "default",
